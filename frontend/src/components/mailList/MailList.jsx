  ...
  return (
    <footer className="bg-gradient-to-b from-gray-50 to-gray-100 pt-20 pb-8">
      <div className="w-full max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-14 pb-10 border-b border-gray-200">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="w-full md:w-1/2 flex">
              <input 
                ...
                className="w-full px-4 py-3 rounded-l-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent"
              />
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-r-lg transition-colors duration-300 font-medium">
                Subscribe
              </button>
            </div>
          </div>
        ...
        {/* Payment methods */}
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 pt-8 pb-10">
          <div className="mb-6 md:mb-0">
